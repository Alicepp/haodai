	...
	exports.init=function(){
		...
		_checkform.hdbValidForm('registerForm',function(data,index,validForm){
			//data 为服务器返回的对象
			...
			if(data.status == API_SUCCESS){  //成功
	        	dialog = {
					setValue: {   
						title: "",  
						html: true, 
						text: '<div class="success-cont"><div class="success-img register-img"></div><p>'+ data.message +'</p></div>',
